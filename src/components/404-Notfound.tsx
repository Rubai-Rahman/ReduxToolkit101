      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center space-x-2 mb-8">
            <div className="w-12 h-12 bg-gradient-to-br from-[#ff6b6b] via-[var(--primary-start)] to-[var(--primary-end)] rounded-lg flex items-center justify-center">
              <CheckCircle className="h-6 w-6 text-white" />
            </div>
            <span className="text-3xl font-bold bg-gradient-to-r from-[#ff6b6b] via-[var(--primary-start)] to-[var(--primary-end)] bg-clip-text text-transparent">
              taskNest
            </span>
          </div>
          ...
          <Card className="border border-border/50 shadow-2xl bg-gradient-to-br from-card/90 to-card/70 backdrop-blur-xl">
            <CardHeader className="pb-4">
              <div className="w-20 h-20 bg-gradient-to-br from-[#ff6b6b]/20 to-[var(--primary-end)]/20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <span className="text-4xl font-bold bg-gradient-to-r from-[#ff6b6b] to-[var(--primary-end)] bg-clip-text text-transparent">
                  404
                </span>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-[#ff6b6b] to-[var(--primary-start)] hover:from-[var(--primary-start)] hover:to-[var(--primary-end)] shadow-lg"
                >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <a
                href="/support"
                className="text-transparent bg-gradient-to-r from-[var(--primary-start)] to-[var(--primary-end)] bg-clip-text font-semibold hover:underline"
              >
                support team
              </a>
            </p>
